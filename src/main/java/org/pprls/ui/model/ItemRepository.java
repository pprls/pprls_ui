...
public enum ItemRepository {
    ...
    private ItemRepository() {
        try {
            ...
            newItem.getAttachments().add(new AttachmentImpl<URL>(PDF, new URL("file:///N:/scanner/Color0211.pdf"), true));
            newItem.getAttachments().add(new AttachmentImpl<String>(RTF, "Sample <strong>text</strong>", false));
            newItem.getAttachments().add(new AttachmentImpl<URL>(PDF, new URL("file:///N:/scanner/Color0213.pdf"), true));
            ...
            newItem.getAttachments().add(new AttachmentImpl<URL>(PDF, new URL("file:///N:/scanner/Color0208.pdf"), false));
            newItem.getAttachments().add(new AttachmentImpl<String>(RTF, "Sample <strong>text</strong>", true));
            newItem.getAttachments().add(new AttachmentImpl<URL>(PDF, new URL("file:///N:/scanner/Color210.pdf"), false));
            itemList.add(newItem);
            ...
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0208.pdf"), false));
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0209.pdf"), true));
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0210.pdf"), false));
            itemList.add(newItem);
            ...
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0211.pdf"), true));
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0212.pdf"), false));
            newItem.getAttachments().add(new AttachmentImpl(PDF, new URL("file:///N:/scanner/Color0213.pdf"), true));
            itemList.add(newItem);
