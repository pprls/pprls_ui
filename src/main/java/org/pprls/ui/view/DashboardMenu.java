...
import org.pprls.ui.component.ProfilePreferencesWindow;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("Επιφάνεια εποπτείας <strong>Paperless</strong>",
                ContentMode.HTML);
    ...
    private Component buildUserMenu() {
        ...
        updateUserName(null);
        settingsItem.addItem("Επεξεργασία προφίλ", new Command() {
            @Override
            public void menuSelected(final MenuItem selectedItem) { ProfilePreferencesWindow.open(user, false); }
        });
        settingsItem.addItem("Προτιμήσεις", new Command() {
            @Override
        ...
        settingsItem.addItem("Αποσύνδεση", new Command() {
            @Override
            public void menuSelected(final MenuItem selectedItem) { DashboardEventBus.post(new DashboardEvent.UserLoggedOutEvent()); }
        });
        return settings;
    }

    private Component buildToggleButton() {
        Button valoMenuToggleButton = new Button("Επιλογές", new ClickListener() {
            @Override
...
//            }
    ...
    public final class ValoMenuItemButton extends Button {
        ...
        public ValoMenuItemButton(final DashboardViewType view) {
            ...
            setCaption(view.getViewUiName().substring(0, 1).toUpperCase()
                    + view.getViewUiName().substring(1));
            DashboardEventBus.register(this);
            addClickListener(click-> UI.getCurrent().getNavigator().navigateTo(view.getViewName()));
